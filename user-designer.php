                ...
                <div class="overflow-off">
                    <div data-w-id="1fd6d305-6679-7cb9-fb3a-46939f11c7c4" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d" class="w-clearfix">
                        <h1 class="home-hero-heading">
                            <span style="font-size: 36px"><span style="color:#0070DF">User-Centered</span> Design</span><br>
                            <span style="color:#0070DF">Test</span> UX and design.<br />
                            <span style="color:#0070DF">Understand</span> users.<br />
                            <span style="color:#0070DF">Iterate</span> to perfection.
                        </h1>
                    </div>
                </div>
                <div class="overflow-off">
                    <p data-w-id="ed211d01-a9c7-1804-c0ae-c31feba0ee95" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d; margin-top: 50px" class="hero-para-two">Create delightful experiences. Test User Experience with real people.<br>Iterate based on real feedback from users with UX Research surveys.</p>
                </div>
                <div class="overflow-off">
...
<!-- Mobile hero section -->
<section class="home-hero-section-one wf-section mobile-only" style="background: #fff; padding: 100px 0 170px; background-image: url('./assets/images_new/bg-final.png'); background-size: cover; background-position: 0 0">
    <div class="home-hero-container-large w-container">
        <div class="home-hero-main-block">
            ...
            <div class="home-hero-caption-block">
                ...
                <div class="overflow-off">
                    <p style="margin-top: 20px" class="hero-para-two">
                        Create delightful experiences. Test User Experience with real people.<br>
                        Iterate based on real feedback from users with UX Research surveys.
                    </p>
                </div>
                <div class="overflow-off">
                    <!-- Buttons -->
                    <div class="hero-caption-buttons-one">
                        ...
                        <a role="button" onclick="book_a_demo();" class="trial-button feature-button w-inline-block">
                            <div class="trail-text">Book a demo</div>
                        </a>
                    </div>
                </div>
            </div>

            <!-- Hero Images Section Moved to Bottom -->
        </div>
        <div class="home-hero-image-block">
            <div class="banner-girl-image-block">
                <img src="./assets/images_new/design-back.png" loading="lazy" alt="Banner Girl Image" class="hero-main-image">
            </div>
            <div class="banner-float-images">
                <div class="float-image-one">
                    <img src="../assets/images_new/marketing-1.png" loading="lazy" alt="Banner Image One" class="float-image">
                </div>
                <div class="float-image-two">
                    <img src="./assets/images_new/ux-1.png" loading="lazy" alt="Finance" class="float-image">
                </div>
                <div class="float-image-three">
                    <img src="./assets/images_new/ux-3.png" loading="lazy" alt="Order Value" class="float-image">
                </div>
            </div>
        </div>
    </div>
...
<section class="strategy-section wf-section" style="background-color: #f9fafb;padding-top: 50px;background-image: url('./assets/images_new/bg4.png');background-size: cover;background-position: 0 0">
    <div class="page-container w-container">
        <div class="services-block">
            ...
            <h2 class="strategy-heading"><span style="color:#0070DF">Real</span> feedback. <span style="color:#0070DF">Better</span> experiences. <span style="color:#0070DF">Happy</span> users.</h2>
                ...
                <div id="w-node-fa1a0254-dc6a-ccfd-1cb6-a3a8553d22d4-d8996253" class="features-services-block">
                    <div id="w-node-fa1a0254-dc6a-ccfd-1cb6-a3a8553d22d5-d8996253" data-w-id="fa1a0254-dc6a-ccfd-1cb6-a3a8553d22d5" class="analytics" style="background-color: #CBE5FF">
                        <div class="services-title">
                            ...
                            <div data-w-id="fa1a0254-dc6a-ccfd-1cb6-a3a8553d22d9" class="bold-text" style="color: rgb(34, 34, 34);">Test design and copy</div>
                        </div>
                        <ul style="margin-left:-25px">
                            <li>Optimize Landing Pages, websites</li>
                            <li>Validate overall app design</li>
                            <li>Adjust app messaging</li>
                        </ul>
                ...
                <div id="w-node-fa1a0254-dc6a-ccfd-1cb6-a3a8553d22e0-d8996253" data-w-id="fa1a0254-dc6a-ccfd-1cb6-a3a8553d22e0" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="features-services-block">
                    <div id="w-node-fa1a0254-dc6a-ccfd-1cb6-a3a8553d22e1-d8996253" data-w-id="fa1a0254-dc6a-ccfd-1cb6-a3a8553d22e1" class="analytics" style="background-color: #CBE5FF">
                        <div class="services-title">
                            ...
                            <div data-w-id="fa1a0254-dc6a-ccfd-1cb6-a3a8553d22e5" class="bold-text" style="color: rgb(34, 34, 34);">Test Figma prototypes</div>
                        </div>
                        <ul style="margin-left:-25px">
                            <li>Integration in minutes</li>
                            <li>Control prototype exposure time</li>
                ...
                <div id="w-node-fa1a0254-dc6a-ccfd-1cb6-a3a8553d22ec-d8996253" data-w-id="fa1a0254-dc6a-ccfd-1cb6-a3a8553d22ec" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="features-services-block">
                    <div id="w-node-fa1a0254-dc6a-ccfd-1cb6-a3a8553d22ed-d8996253" data-w-id="fa1a0254-dc6a-ccfd-1cb6-a3a8553d22ed" class="analytics" style="background-color: #CBE5FF">
                        <div class="services-title">
                            ...
                            <div data-w-id="fa1a0254-dc6a-ccfd-1cb6-a3a8553d22f1" class="bold-text" style="color: rgb(34, 34, 34);">Quick A/B Tests</div>
                        </div>
                        <ul style="margin-left:-25px">
